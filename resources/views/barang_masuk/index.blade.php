        ...
        <div class="col-12">
            <div class="card">
                ...
                <form id="form" enctype="multipart/form-data">
                    ...
                    <div class="card-body col-sm-12">
                        <div class="form-group has-feedback">
                            <b><label>Jumlah Barang Masuk</label></b>
                            <input type="text" id="jumlah_barang_masuk" class="form-control"
                                placeholder="Jumlah Barang Masuk" name="jumlah_barang_masuk">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/function/barang_masuk.js') }}"></script>
