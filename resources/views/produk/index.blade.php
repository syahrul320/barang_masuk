                ...
                <form id="form" enctype="multipart/form-data">
                    ...
                    <div class="card-body col-sm-12">
                        <div class="form-group has-feedback">
                            <b><label>Kode Produk</label></b>
                            <input type="text" id="kode_barang" class="form-control" placeholder="Kode Produk"
                                name="kode_barang">
                            <span class="text-danger" id="kode_barangError"></span>
                        </div>
                    </div>
                    <div class="card-body col-sm-12">
                        <div class="form-group has-feedback">
                            <b><label>Nama Produk</label></b>
                            <input type="text" id="nama_barang" class="form-control" placeholder="Nama Produk"
                                name="nama_barang">
                    ...
                    <div class="card-body col-sm-12">
                        <div class="form-group has-feedback">
                            <label>Rasa</label>
                            <select id='id_rasa' class='form-control' name="id_rasa">
