...
$(document).ready(function () {
    ...
    $("#form").submit(function (e) {
        ...
        if ($("#id").val() != "") {
            text = "Update";
            action = "Update";
            urlSubmit = url + "/barang_masuk-update-data";
        } else {
            text = "Simpan";
            action = "Simpan";
            urlSubmit = url + "/barang_masuk-insert-data";
        }
    ...
    $("#id_produk").select2({
        ajax: {
            url: url + "/topup-user-card-select",
            type: "post",
            dataType: "json",
            delay: 250,
    ...
    $("#produkku").select2({
        ajax: {
            url: url + "/produk-user-card-select",
            type: "post",
            dataType: "json",
            delay: 250,
            data: function (params) {
...
function destroy(id) {
    swal({
        ...
        if (willDelete) {
            $.ajax({
                type: "DELETE",
                url: url + "/barang_masuk-delete-data",
                data: { id: id },
                method: "POST",
